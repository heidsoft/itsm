  ...
  theme: {
    extend: {
      colors: {
        ...
        // Amber (用于 priority-high，与 status-open 的 blue 区分)
        amber: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
        ...
        // lightAmber: 仅用于 priority-high 标签，与 orange 区分
        lightAmber: {
          50: '#fffbeb',
          100: '#fef3c7',
          700: '#b45309',
        ...
        // Orange (用于 status-open，与 priority-high 的 amber 区分)
        orange: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
