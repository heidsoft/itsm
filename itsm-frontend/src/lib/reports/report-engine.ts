...
export class ReportEngine {
   ...
   * 应用分组
   */
  static applyGrouping(data: unknown[], grouping: ReportGrouping[]): Record<string, any[]> {
   ...
   * 应用聚合
   */
  static applyAggregation(data: unknown[], metrics: AggregationMetric[]): Record<string, any> {
