        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#products" className="text-gray-600 hover:text-purple-600 transition">
                产品
              </a>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a
                href="#products"
                className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-purple-600 transition"
              >
                📖 了解产品
              </a>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition">
              ...
              <div className="p-8">
                ...
                <div className="flex gap-4">
                  <a
                    href="/deploy"
                    className="flex-1 bg-blue-500 text-white text-center py-3 rounded-lg font-semibold hover:bg-blue-600 transition"
                  >
                    立即体验
                  </a>
                  <a
                    href="#contact"
                    className="flex-1 border-2 border-blue-500 text-blue-500 text-center py-3 rounded-lg font-semibold hover:bg-blue-50 transition"
                  >
                    预约演示
                  </a>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition">
              ...
              <div className="p-8">
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    href="#contact"
                    className="flex-1 border-2 border-purple-500 text-purple-500 text-center py-3 rounded-lg font-semibold hover:bg-purple-50 transition"
                  >
                    预约演示
                  </a>
                </div>
            ...
            {[
              {
                icon: '🤖',
                title: 'AI 智能赋能',
                desc: 'AI 驱动的自动化和智能分析，让 IT 管理更简单高效',
              },
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              href="mailto:sales@cloudmesh.top"
              className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-purple-600 transition"
            >
              📧 联系我们
            </a>
