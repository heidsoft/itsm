...
export const ApplyRdsForm = () => {
  return (
    <div className='space-y-6'>
      {/* 数据库引擎 */}
      <div>
        <label htmlFor='db-engine' className='block text-sm font-medium text-gray-700'>
          数据库引擎
        </label>
        <select
          id='db-engine'
      ...
      {/* 实例规格 */}
      <div>
        <label htmlFor='db-instance-class' className='block text-sm font-medium text-gray-700'>
          实例规格
        </label>
        <select
      ...
      {/* 存储空间 */}
      <div>
        <label htmlFor='storage-size' className='block text-sm font-medium text-gray-700'>
          存储空间 (GB)
        </label>
        <input
          type='number'
      ...
      {/* 管理员账号 */}
      <div>
        <label htmlFor='master-username' className='block text-sm font-medium text-gray-700'>
          管理员账号
        </label>
        <input
          type='text'
