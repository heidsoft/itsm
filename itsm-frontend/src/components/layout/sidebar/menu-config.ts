...
export function getMenuConfig(): MenuConfig {
  return {
    main: [
      ...
      {
        key: '/email-intake',
        icon: getIconByName('Inbox')!,
        label: '邮件报障',
        path: '/email-intake',
        permission: 'email_intake:read',
        description: 'AI 邮件智能报障',
        children: [
          {
            key: '/email-intake/conversations',
            icon: getIconByName('Inbox')!,
            label: '报障会话',
            path: '/email-intake',
            permission: 'email_intake:read',
          ...
          {
            key: '/email-intake/customers',
            icon: getIconByName('Users')!,
            label: '客户资料',
            path: '/email-intake/customers',
            permission: 'customer_master:read',
          },
          {
            key: '/email-intake/contracts',
            icon: getIconByName('FileText')!,
            label: '支持合同',
            path: '/email-intake/contracts',
            permission: 'support_contract:read',
          },
          {
            key: '/email-intake/sources',
            icon: getIconByName('Globe')!,
            label: '来源组织',
            path: '/email-intake/sources',
            permission: 'customer_master:read',
          },
          {
            key: '/email-intake/on-call',
            icon: getIconByName('Clock')!,
            label: '值班排班',
            path: '/email-intake/on-call',
            permission: 'on_call:read',
          },
        ],
      },
      {
