  ...
  (
    ...
    const getButtonStyles = () => {
      const baseStyles = {
        ...
        fontWeight: 500,
        borderRadius: shape === "round" ? "9999px" : shape === "circle" ? "50%" : token.borderRadius,
      };
    ...
    return (
      <button
        ...
        style={{
          ...getButtonStyles(),
          "--hover-bg": getHoverStyles().backgroundColor,
          "--hover-border": getHoverStyles().borderColor,
          "--hover-transform": getHoverStyles().transform,
          "--hover-shadow": getHoverStyles().boxShadow,
          "--active-transform": getActiveStyles().transform,
          "--active-shadow": getActiveStyles().boxShadow,
