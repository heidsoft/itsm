...
import { Zap, AlertCircle, Info, ChevronsDown } from 'lucide-react';
...
export const TicketCard = ({ id, title, status, priority, lastUpdate, type = '事件' }) => {
    ...
    return (
        ...
        >
            ...
            <p className="text-sm text-gray-600 mb-4">{type}ID: {id}</p>
