              ...
              >
                <Descriptions column={2} bordered>
                  ...
                  <Descriptions.Item label='自动分类'>
                    <Badge
                      status={classification.auto_classified ? 'success' : 'default'}
                      text={classification.auto_classified ? '是' : '否'}
                    />
                  </Descriptions.Item>
              ...
              >
                <div className='space-y-6'>
                  ...
                  <div className='flex justify-between text-sm text-gray-600'>
                    ...
                    <span>
                      状态:{' '}
                      <Tag color={rootCauseAnalysis.status === 'completed' ? 'green' : 'orange'}>
                    ...
                    <Card size='small' title='业务影响'>
                      <div className='space-y-3'>
                        ...
                        <div className='flex justify-between items-center'>
                          <span>合规影响:</span>
                          <Badge
                            status={impactAssessment.compliance_impact ? 'error' : 'success'}
                            text={impactAssessment.compliance_impact ? '有' : '无'}
                          />
                        </div>
                      </div>
                    </Card>
                      ...
                      <div className='space-y-3'>
                        <div className='flex justify-between items-center'>
                          ...
                          <span className='font-medium'>
                            {impactAssessment.affected_users_count.toLocaleString()} 人
                          </span>
                        </div>
                        <div className='flex justify-between items-center'>
                          <span>财务损失:</span>
                          <span className='font-medium text-red-600'>
                            ¥{impactAssessment.financial_impact.toLocaleString()}
                          </span>
                        </div>
                        <div>
                  ...
                  <Col xs={24}>
                    <Card size='small' title='评估说明'>
                      ...
                      <div className='flex justify-between text-sm text-gray-600'>
                        ...
                        <span>
                          评估时间: {new Date(impactAssessment.created_at!).toLocaleString('zh-CN')}
                        </span>
                      </div>
                    </Card>
                  </Col>
              ...
              {classification && (
                <Timeline.Item color='green' dot={<BugOutlined />}>
                  <div className='mb-2'>
                    ...
                    <span className='text-gray-500 ml-2'>
                      {new Date(classification.created_at!).toLocaleString('zh-CN')}
                    </span>
                  </div>
                  <p className='text-gray-600'>
                    事件被分类为: {classification.category} - {classification.subcategory}
                  </p>
                </Timeline.Item>
              )}
              ...
              {impactAssessment && (
                <Timeline.Item color='orange' dot={<ExclamationCircleOutlined />}>
                  <div className='mb-2'>
                    ...
                    <span className='text-gray-500 ml-2'>
                      {new Date(impactAssessment.created_at!).toLocaleString('zh-CN')}
                    </span>
                  </div>
                  <p className='text-gray-600'>
                    完成影响评估，业务影响等级: {impactAssessment.business_impact}
                  </p>
                </Timeline.Item>
              )}
              ...
              {rootCauseAnalysis && (
                <Timeline.Item color='red' dot={<SafetyOutlined />}>
                  <div className='mb-2'>
                    ...
                    <span className='text-gray-500 ml-2'>
                      {new Date(rootCauseAnalysis.created_at!).toLocaleString('zh-CN')}
                    </span>
                  </div>
        ...
        >
          ...
          <Form.Item>
            <Space>
              ...
              <Button onClick={() => setShowRootCauseModal(false)}>取消</Button>
            </Space>
          </Form.Item>
        </Form>
      </Modal>
        ...
        >
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                ...
                rules={[{ required: true, message: '请选择业务影响等级' }]}
              >
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[{ required: true, message: '请选择技术影响等级' }]}
              >
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                ...
                rules={[{ required: true, message: '请选择声誉影响' }]}
              >
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                ...
                rules={[{ required: true, message: '请输入财务损失' }]}
              >
          ...
          <Form.Item>
            <Space>
              ...
              <Button onClick={() => setShowImpactModal(false)}>取消</Button>
            </Space>
          </Form.Item>
        </Form>
      </Modal>
