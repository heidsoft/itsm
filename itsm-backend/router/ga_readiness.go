...
func buildGAReadiness(ctx context.Context, client *ent.Client) gaReadinessResponse {
	modules := []gaReadinessModule{
		...
		{Key: "process_bindings", Name: "流程绑定", Status: "ready", Endpoint: "/api/v1/bpmn/process-bindings", DataCount: countOrZero(ctx, client, "process_bindings")},
		{Key: "cmdb_types", Name: "CMDB 类型模板", Status: "ready", Endpoint: "/api/v1/cmdb-types", DataCount: countOrZero(ctx, client, "ci_types")},
