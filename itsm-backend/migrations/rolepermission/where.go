...
func PermissionIDGT(v int) predicate.RolePermission {
...
func PermissionIDGTE(v int) predicate.RolePermission {
...
func PermissionIDLT(v int) predicate.RolePermission {
