...
func (_q *ProjectQuery) QueryDepartment() *DepartmentQuery {
...
func (_q *ProjectQuery) QueryApplications() *ApplicationQuery {
...
func (_q *ProjectQuery) WithDepartment(opts ...func(*DepartmentQuery)) *ProjectQuery {
	query := (&DepartmentClient{config: _q.config}).Query()
...
func (_q *ProjectQuery) WithApplications(opts ...func(*ApplicationQuery)) *ProjectQuery {
	query := (&ApplicationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProjectQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Project, error) {
	...
	if query := _q.withDepartment; query != nil {
		if err := _q.loadDepartment(ctx, query, nodes, nil,
			func(n *Project, e *Department) { n.Edges.Department = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *ProjectQuery) loadDepartment(ctx context.Context, query *DepartmentQuery, nodes []*Project, init func(*Project), assign func(*Project, *Department)) error {
...
func (_q *ProjectQuery) loadApplications(ctx context.Context, query *ApplicationQuery, nodes []*Project, init func(*Project), assign func(*Project, *Application)) error {
...
func (_q *ProjectQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withDepartment != nil {
			_spec.Node.AddColumnOnce(project.FieldDepartmentID)
		}
	}
