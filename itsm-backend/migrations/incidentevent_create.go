...
func (_c *IncidentEventCreate) check() error {
	if _, ok := _c.mutation.IncidentID(); !ok {
		return &ValidationError{Name: "incident_id", err: errors.New(`migrations: missing required field "IncidentEvent.incident_id"`)}
	}
	...
	if _, ok := _c.mutation.EventType(); !ok {
		return &ValidationError{Name: "event_type", err: errors.New(`migrations: missing required field "IncidentEvent.event_type"`)}
	}
	...
	if _, ok := _c.mutation.EventName(); !ok {
		return &ValidationError{Name: "event_name", err: errors.New(`migrations: missing required field "IncidentEvent.event_name"`)}
	}
	...
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "IncidentEvent.status"`)}
	}
	if _, ok := _c.mutation.Severity(); !ok {
		return &ValidationError{Name: "severity", err: errors.New(`migrations: missing required field "IncidentEvent.severity"`)}
	}
	if _, ok := _c.mutation.OccurredAt(); !ok {
		return &ValidationError{Name: "occurred_at", err: errors.New(`migrations: missing required field "IncidentEvent.occurred_at"`)}
	}
	if _, ok := _c.mutation.Source(); !ok {
		return &ValidationError{Name: "source", err: errors.New(`migrations: missing required field "IncidentEvent.source"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "IncidentEvent.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "IncidentEvent.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "IncidentEvent.updated_at"`)}
	}
	if len(_c.mutation.IncidentIDs()) == 0 {
		return &ValidationError{Name: "incident", err: errors.New(`migrations: missing required edge "IncidentEvent.incident"`)}
	}
	return nil
}
