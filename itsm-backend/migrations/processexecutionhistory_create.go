...
func (_c *ProcessExecutionHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryID(); !ok {
		return &ValidationError{Name: "history_id", err: errors.New(`migrations: missing required field "ProcessExecutionHistory.history_id"`)}
	}
	if v, ok := _c.mutation.HistoryID(); ok {
		if err := processexecutionhistory.HistoryIDValidator(v); err != nil {
			return &ValidationError{Name: "history_id", err: fmt.Errorf(`migrations: validator failed for field "ProcessExecutionHistory.history_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.ProcessInstanceID(); !ok {
		return &ValidationError{Name: "process_instance_id", err: errors.New(`migrations: missing required field "ProcessExecutionHistory.process_instance_id"`)}
	}
	if v, ok := _c.mutation.ProcessInstanceID(); ok {
		if err := processexecutionhistory.ProcessInstanceIDValidator(v); err != nil {
			return &ValidationError{Name: "process_instance_id", err: fmt.Errorf(`migrations: validator failed for field "ProcessExecutionHistory.process_instance_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.ProcessDefinitionKey(); !ok {
		return &ValidationError{Name: "process_definition_key", err: errors.New(`migrations: missing required field "ProcessExecutionHistory.process_definition_key"`)}
	}
	if v, ok := _c.mutation.ProcessDefinitionKey(); ok {
		if err := processexecutionhistory.ProcessDefinitionKeyValidator(v); err != nil {
			return &ValidationError{Name: "process_definition_key", err: fmt.Errorf(`migrations: validator failed for field "ProcessExecutionHistory.process_definition_key": %w`, err)}
		}
	}
	if _, ok := _c.mutation.ActivityType(); !ok {
		return &ValidationError{Name: "activity_type", err: errors.New(`migrations: missing required field "ProcessExecutionHistory.activity_type"`)}
	}
	if v, ok := _c.mutation.ActivityType(); ok {
		if err := processexecutionhistory.ActivityTypeValidator(v); err != nil {
			return &ValidationError{Name: "activity_type", err: fmt.Errorf(`migrations: validator failed for field "ProcessExecutionHistory.activity_type": %w`, err)}
		}
	}
	if _, ok := _c.mutation.EventType(); !ok {
		return &ValidationError{Name: "event_type", err: errors.New(`migrations: missing required field "ProcessExecutionHistory.event_type"`)}
	}
	if v, ok := _c.mutation.EventType(); ok {
		if err := processexecutionhistory.EventTypeValidator(v); err != nil {
			return &ValidationError{Name: "event_type", err: fmt.Errorf(`migrations: validator failed for field "ProcessExecutionHistory.event_type": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Timestamp(); !ok {
		return &ValidationError{Name: "timestamp", err: errors.New(`migrations: missing required field "ProcessExecutionHistory.timestamp"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "ProcessExecutionHistory.tenant_id"`)}
	}
	if v, ok := _c.mutation.TenantID(); ok {
		if err := processexecutionhistory.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "ProcessExecutionHistory.tenant_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ProcessExecutionHistory.created_at"`)}
	}
	if len(_c.mutation.ProcessInstanceIDs()) == 0 {
		return &ValidationError{Name: "process_instance", err: errors.New(`migrations: missing required edge "ProcessExecutionHistory.process_instance"`)}
	}
	return nil
}
