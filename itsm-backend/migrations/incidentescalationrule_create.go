...
func (_c *IncidentEscalationRuleCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`migrations: missing required field "IncidentEscalationRule.name"`)}
	}
	...
	if _, ok := _c.mutation.TriggerType(); !ok {
		return &ValidationError{Name: "trigger_type", err: errors.New(`migrations: missing required field "IncidentEscalationRule.trigger_type"`)}
	}
	...
	if _, ok := _c.mutation.EscalationLevel(); !ok {
		return &ValidationError{Name: "escalation_level", err: errors.New(`migrations: missing required field "IncidentEscalationRule.escalation_level"`)}
	}
	if _, ok := _c.mutation.TriggerMinutes(); !ok {
		return &ValidationError{Name: "trigger_minutes", err: errors.New(`migrations: missing required field "IncidentEscalationRule.trigger_minutes"`)}
	}
	...
	if _, ok := _c.mutation.TargetAssigneeType(); !ok {
		return &ValidationError{Name: "target_assignee_type", err: errors.New(`migrations: missing required field "IncidentEscalationRule.target_assignee_type"`)}
	}
	...
	if _, ok := _c.mutation.AutoEscalate(); !ok {
		return &ValidationError{Name: "auto_escalate", err: errors.New(`migrations: missing required field "IncidentEscalationRule.auto_escalate"`)}
	}
	if _, ok := _c.mutation.IsActive(); !ok {
		return &ValidationError{Name: "is_active", err: errors.New(`migrations: missing required field "IncidentEscalationRule.is_active"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "IncidentEscalationRule.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "IncidentEscalationRule.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "IncidentEscalationRule.updated_at"`)}
	}
	return nil
}
