...
// EngineerSkillQuery is the builder for querying EngineerSkill entities.
type EngineerSkillQuery struct {
	config
	ctx        *QueryContext
	order      []engineerskill.OrderOption
	inters     []Interceptor
	predicates []predicate.EngineerSkill
...
func (_q *EngineerSkillQuery) First(ctx context.Context) (*EngineerSkill, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{engineerskill.Label}
	}
	return nodes[0], nil
}
...
func (_q *EngineerSkillQuery) Only(ctx context.Context) (*EngineerSkill, error) {
	...
	case 0:
		return nil, &NotFoundError{engineerskill.Label}
	default:
		return nil, &NotSingularError{engineerskill.Label}
	}
}
...
func (_q *EngineerSkillQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{engineerskill.Label}
	default:
		err = &NotSingularError{engineerskill.Label}
	}
	return
}
...
func (_q *EngineerSkillQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != engineerskill.FieldID {
...
// EngineerSkillGroupBy is the group-by builder for EngineerSkill entities.
type EngineerSkillGroupBy struct {
	selector
	build *EngineerSkillQuery
}
...
// EngineerSkillSelect is the builder for selecting fields of EngineerSkill entities.
type EngineerSkillSelect struct {
	*EngineerSkillQuery
	selector
}
