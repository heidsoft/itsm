...
func (_c *CIAttributeDefinitionCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`migrations: missing required field "CIAttributeDefinition.name"`)}
	}
	...
	if _, ok := _c.mutation.DisplayName(); !ok {
		return &ValidationError{Name: "display_name", err: errors.New(`migrations: missing required field "CIAttributeDefinition.display_name"`)}
	}
	...
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`migrations: missing required field "CIAttributeDefinition.type"`)}
	}
	...
	if _, ok := _c.mutation.Required(); !ok {
		return &ValidationError{Name: "required", err: errors.New(`migrations: missing required field "CIAttributeDefinition.required"`)}
	}
	if _, ok := _c.mutation.Unique(); !ok {
		return &ValidationError{Name: "unique", err: errors.New(`migrations: missing required field "CIAttributeDefinition.unique"`)}
	}
	if _, ok := _c.mutation.CiTypeID(); !ok {
		return &ValidationError{Name: "ci_type_id", err: errors.New(`migrations: missing required field "CIAttributeDefinition.ci_type_id"`)}
	}
	...
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "CIAttributeDefinition.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.IsActive(); !ok {
		return &ValidationError{Name: "is_active", err: errors.New(`migrations: missing required field "CIAttributeDefinition.is_active"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "CIAttributeDefinition.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "CIAttributeDefinition.updated_at"`)}
	}
	return nil
}
