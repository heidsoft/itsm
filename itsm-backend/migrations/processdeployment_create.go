...
func (_c *ProcessDeploymentCreate) check() error {
	if _, ok := _c.mutation.DeploymentID(); !ok {
		return &ValidationError{Name: "deployment_id", err: errors.New(`migrations: missing required field "ProcessDeployment.deployment_id"`)}
	}
	if v, ok := _c.mutation.DeploymentID(); ok {
		if err := processdeployment.DeploymentIDValidator(v); err != nil {
			return &ValidationError{Name: "deployment_id", err: fmt.Errorf(`migrations: validator failed for field "ProcessDeployment.deployment_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DeploymentName(); !ok {
		return &ValidationError{Name: "deployment_name", err: errors.New(`migrations: missing required field "ProcessDeployment.deployment_name"`)}
	}
	if v, ok := _c.mutation.DeploymentName(); ok {
		if err := processdeployment.DeploymentNameValidator(v); err != nil {
			return &ValidationError{Name: "deployment_name", err: fmt.Errorf(`migrations: validator failed for field "ProcessDeployment.deployment_name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DeploymentTime(); !ok {
		return &ValidationError{Name: "deployment_time", err: errors.New(`migrations: missing required field "ProcessDeployment.deployment_time"`)}
	}
	if _, ok := _c.mutation.IsActive(); !ok {
		return &ValidationError{Name: "is_active", err: errors.New(`migrations: missing required field "ProcessDeployment.is_active"`)}
	}
	if _, ok := _c.mutation.DeploymentCategory(); !ok {
		return &ValidationError{Name: "deployment_category", err: errors.New(`migrations: missing required field "ProcessDeployment.deployment_category"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "ProcessDeployment.tenant_id"`)}
	}
	if v, ok := _c.mutation.TenantID(); ok {
		if err := processdeployment.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "ProcessDeployment.tenant_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ProcessDeployment.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "ProcessDeployment.updated_at"`)}
	}
	return nil
}
