...
func (_c *ToolInvocationCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ToolInvocation.created_at"`)}
	}
	if _, ok := _c.mutation.ConversationID(); !ok {
		return &ValidationError{Name: "conversation_id", err: errors.New(`migrations: missing required field "ToolInvocation.conversation_id"`)}
	}
	if _, ok := _c.mutation.ToolName(); !ok {
		return &ValidationError{Name: "tool_name", err: errors.New(`migrations: missing required field "ToolInvocation.tool_name"`)}
	}
	if _, ok := _c.mutation.Arguments(); !ok {
		return &ValidationError{Name: "arguments", err: errors.New(`migrations: missing required field "ToolInvocation.arguments"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "ToolInvocation.status"`)}
	}
	if _, ok := _c.mutation.NeedsApproval(); !ok {
		return &ValidationError{Name: "needs_approval", err: errors.New(`migrations: missing required field "ToolInvocation.needs_approval"`)}
	}
	if _, ok := _c.mutation.ApprovalState(); !ok {
		return &ValidationError{Name: "approval_state", err: errors.New(`migrations: missing required field "ToolInvocation.approval_state"`)}
	}
	if _, ok := _c.mutation.ApprovalReason(); !ok {
		return &ValidationError{Name: "approval_reason", err: errors.New(`migrations: missing required field "ToolInvocation.approval_reason"`)}
	}
	if _, ok := _c.mutation.DryRun(); !ok {
		return &ValidationError{Name: "dry_run", err: errors.New(`migrations: missing required field "ToolInvocation.dry_run"`)}
	}
	if len(_c.mutation.ConversationIDs()) == 0 {
		return &ValidationError{Name: "conversation", err: errors.New(`migrations: missing required edge "ToolInvocation.conversation"`)}
	}
	return nil
}
