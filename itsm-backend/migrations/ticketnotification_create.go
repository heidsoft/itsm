...
func (_c *TicketNotificationCreate) check() error {
	if _, ok := _c.mutation.TicketID(); !ok {
		return &ValidationError{Name: "ticket_id", err: errors.New(`migrations: missing required field "TicketNotification.ticket_id"`)}
	}
	if v, ok := _c.mutation.TicketID(); ok {
		if err := ticketnotification.TicketIDValidator(v); err != nil {
			return &ValidationError{Name: "ticket_id", err: fmt.Errorf(`migrations: validator failed for field "TicketNotification.ticket_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`migrations: missing required field "TicketNotification.user_id"`)}
	}
	if v, ok := _c.mutation.UserID(); ok {
		if err := ticketnotification.UserIDValidator(v); err != nil {
			return &ValidationError{Name: "user_id", err: fmt.Errorf(`migrations: validator failed for field "TicketNotification.user_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`migrations: missing required field "TicketNotification.type"`)}
	}
	if v, ok := _c.mutation.GetType(); ok {
		if err := ticketnotification.TypeValidator(v); err != nil {
			return &ValidationError{Name: "type", err: fmt.Errorf(`migrations: validator failed for field "TicketNotification.type": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Channel(); !ok {
		return &ValidationError{Name: "channel", err: errors.New(`migrations: missing required field "TicketNotification.channel"`)}
	}
	if _, ok := _c.mutation.Content(); !ok {
		return &ValidationError{Name: "content", err: errors.New(`migrations: missing required field "TicketNotification.content"`)}
	}
	if v, ok := _c.mutation.Content(); ok {
		if err := ticketnotification.ContentValidator(v); err != nil {
			return &ValidationError{Name: "content", err: fmt.Errorf(`migrations: validator failed for field "TicketNotification.content": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "TicketNotification.status"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "TicketNotification.tenant_id"`)}
	}
	if v, ok := _c.mutation.TenantID(); ok {
		if err := ticketnotification.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "TicketNotification.tenant_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "TicketNotification.created_at"`)}
	}
	if len(_c.mutation.TicketIDs()) == 0 {
		return &ValidationError{Name: "ticket", err: errors.New(`migrations: missing required edge "TicketNotification.ticket"`)}
	}
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`migrations: missing required edge "TicketNotification.user"`)}
	}
	return nil
}
