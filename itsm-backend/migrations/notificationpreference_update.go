...
func (_u *NotificationPreferenceUpdate) check() error {
	...
	if _u.mutation.UserCleared() && len(_u.mutation.UserIDs()) > 0 {
		return errors.New(`migrations: clearing a required unique edge "NotificationPreference.user"`)
	}
	return nil
}
...
func (_u *NotificationPreferenceUpdateOne) sqlSave(ctx context.Context) (_node *NotificationPreference, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`migrations: missing "NotificationPreference.id" for update`)}
	}
