...
func (_c *AssetCreate) check() error {
	if _, ok := _c.mutation.AssetNumber(); !ok {
		return &ValidationError{Name: "asset_number", err: errors.New(`migrations: missing required field "Asset.asset_number"`)}
	}
	if v, ok := _c.mutation.AssetNumber(); ok {
		if err := asset.AssetNumberValidator(v); err != nil {
			return &ValidationError{Name: "asset_number", err: fmt.Errorf(`migrations: validator failed for field "Asset.asset_number": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`migrations: missing required field "Asset.name"`)}
	}
	if v, ok := _c.mutation.Name(); ok {
		if err := asset.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`migrations: validator failed for field "Asset.name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`migrations: missing required field "Asset.type"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "Asset.status"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "Asset.tenant_id"`)}
	}
	if v, ok := _c.mutation.TenantID(); ok {
		if err := asset.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "Asset.tenant_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "Asset.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "Asset.updated_at"`)}
	}
	return nil
}
