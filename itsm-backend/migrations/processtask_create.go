...
func (_c *ProcessTaskCreate) check() error {
	if _, ok := _c.mutation.TaskID(); !ok {
		return &ValidationError{Name: "task_id", err: errors.New(`migrations: missing required field "ProcessTask.task_id"`)}
	}
	...
	if _, ok := _c.mutation.ProcessInstanceID(); !ok {
		return &ValidationError{Name: "process_instance_id", err: errors.New(`migrations: missing required field "ProcessTask.process_instance_id"`)}
	}
	...
	if _, ok := _c.mutation.ProcessDefinitionKey(); !ok {
		return &ValidationError{Name: "process_definition_key", err: errors.New(`migrations: missing required field "ProcessTask.process_definition_key"`)}
	}
	...
	if _, ok := _c.mutation.TaskDefinitionKey(); !ok {
		return &ValidationError{Name: "task_definition_key", err: errors.New(`migrations: missing required field "ProcessTask.task_definition_key"`)}
	}
	...
	if _, ok := _c.mutation.TaskName(); !ok {
		return &ValidationError{Name: "task_name", err: errors.New(`migrations: missing required field "ProcessTask.task_name"`)}
	}
	...
	if _, ok := _c.mutation.TaskType(); !ok {
		return &ValidationError{Name: "task_type", err: errors.New(`migrations: missing required field "ProcessTask.task_type"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "ProcessTask.status"`)}
	}
	if _, ok := _c.mutation.Priority(); !ok {
		return &ValidationError{Name: "priority", err: errors.New(`migrations: missing required field "ProcessTask.priority"`)}
	}
	if _, ok := _c.mutation.CreatedTime(); !ok {
		return &ValidationError{Name: "created_time", err: errors.New(`migrations: missing required field "ProcessTask.created_time"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "ProcessTask.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ProcessTask.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "ProcessTask.updated_at"`)}
	}
	if len(_c.mutation.ProcessInstanceIDs()) == 0 {
		return &ValidationError{Name: "process_instance", err: errors.New(`migrations: missing required edge "ProcessTask.process_instance"`)}
	}
	return nil
}
