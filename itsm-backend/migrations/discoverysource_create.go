...
func (_c *DiscoverySourceCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`migrations: missing required field "DiscoverySource.name"`)}
	}
	...
	if _, ok := _c.mutation.SourceType(); !ok {
		return &ValidationError{Name: "source_type", err: errors.New(`migrations: missing required field "DiscoverySource.source_type"`)}
	}
	...
	if _, ok := _c.mutation.Enabled(); !ok {
		return &ValidationError{Name: "enabled", err: errors.New(`migrations: missing required field "DiscoverySource.enabled"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "DiscoverySource.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "DiscoverySource.updated_at"`)}
	}
	if v, ok := _c.mutation.ID(); ok {
		if err := discoverysource.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`migrations: validator failed for field "DiscoverySource.id": %w`, err)}
		}
	}
	return nil
}
