...
func (_c *ServiceRequestCreate) check() error {
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "ServiceRequest.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CatalogID(); !ok {
		return &ValidationError{Name: "catalog_id", err: errors.New(`migrations: missing required field "ServiceRequest.catalog_id"`)}
	}
	...
	if _, ok := _c.mutation.RequesterID(); !ok {
		return &ValidationError{Name: "requester_id", err: errors.New(`migrations: missing required field "ServiceRequest.requester_id"`)}
	}
	...
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "ServiceRequest.status"`)}
	}
	if _, ok := _c.mutation.DataClassification(); !ok {
		return &ValidationError{Name: "data_classification", err: errors.New(`migrations: missing required field "ServiceRequest.data_classification"`)}
	}
	if _, ok := _c.mutation.NeedsPublicIP(); !ok {
		return &ValidationError{Name: "needs_public_ip", err: errors.New(`migrations: missing required field "ServiceRequest.needs_public_ip"`)}
	}
	if _, ok := _c.mutation.ComplianceAck(); !ok {
		return &ValidationError{Name: "compliance_ack", err: errors.New(`migrations: missing required field "ServiceRequest.compliance_ack"`)}
	}
	if _, ok := _c.mutation.CurrentLevel(); !ok {
		return &ValidationError{Name: "current_level", err: errors.New(`migrations: missing required field "ServiceRequest.current_level"`)}
	}
	if _, ok := _c.mutation.TotalLevels(); !ok {
		return &ValidationError{Name: "total_levels", err: errors.New(`migrations: missing required field "ServiceRequest.total_levels"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ServiceRequest.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "ServiceRequest.updated_at"`)}
	}
	return nil
}
