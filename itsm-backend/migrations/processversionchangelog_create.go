...
func (_c *ProcessVersionChangelogCreate) check() error {
	if _, ok := _c.mutation.ProcessDefinitionID(); !ok {
		return &ValidationError{Name: "process_definition_id", err: errors.New(`migrations: missing required field "ProcessVersionChangelog.process_definition_id"`)}
	}
	...
	if _, ok := _c.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`migrations: missing required field "ProcessVersionChangelog.version"`)}
	}
	...
	if _, ok := _c.mutation.ChangeLog(); !ok {
		return &ValidationError{Name: "change_log", err: errors.New(`migrations: missing required field "ProcessVersionChangelog.change_log"`)}
	}
	...
	if _, ok := _c.mutation.ChangeType(); !ok {
		return &ValidationError{Name: "change_type", err: errors.New(`migrations: missing required field "ProcessVersionChangelog.change_type"`)}
	}
	...
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "ProcessVersionChangelog.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ProcessVersionChangelog.created_at"`)}
	}
	if len(_c.mutation.ProcessDefinitionIDs()) == 0 {
		return &ValidationError{Name: "process_definition", err: errors.New(`migrations: missing required edge "ProcessVersionChangelog.process_definition"`)}
	}
	return nil
}
