...
func (_c *SLAAlertHistoryCreate) check() error {
	if _, ok := _c.mutation.TicketID(); !ok {
		return &ValidationError{Name: "ticket_id", err: errors.New(`migrations: missing required field "SLAAlertHistory.ticket_id"`)}
	}
	...
	if _, ok := _c.mutation.TicketNumber(); !ok {
		return &ValidationError{Name: "ticket_number", err: errors.New(`migrations: missing required field "SLAAlertHistory.ticket_number"`)}
	}
	...
	if _, ok := _c.mutation.TicketTitle(); !ok {
		return &ValidationError{Name: "ticket_title", err: errors.New(`migrations: missing required field "SLAAlertHistory.ticket_title"`)}
	}
	...
	if _, ok := _c.mutation.AlertRuleID(); !ok {
		return &ValidationError{Name: "alert_rule_id", err: errors.New(`migrations: missing required field "SLAAlertHistory.alert_rule_id"`)}
	}
	...
	if _, ok := _c.mutation.AlertRuleName(); !ok {
		return &ValidationError{Name: "alert_rule_name", err: errors.New(`migrations: missing required field "SLAAlertHistory.alert_rule_name"`)}
	}
	...
	if _, ok := _c.mutation.AlertLevel(); !ok {
		return &ValidationError{Name: "alert_level", err: errors.New(`migrations: missing required field "SLAAlertHistory.alert_level"`)}
	}
	if _, ok := _c.mutation.ThresholdPercentage(); !ok {
		return &ValidationError{Name: "threshold_percentage", err: errors.New(`migrations: missing required field "SLAAlertHistory.threshold_percentage"`)}
	}
	if _, ok := _c.mutation.ActualPercentage(); !ok {
		return &ValidationError{Name: "actual_percentage", err: errors.New(`migrations: missing required field "SLAAlertHistory.actual_percentage"`)}
	}
	if _, ok := _c.mutation.NotificationSent(); !ok {
		return &ValidationError{Name: "notification_sent", err: errors.New(`migrations: missing required field "SLAAlertHistory.notification_sent"`)}
	}
	if _, ok := _c.mutation.EscalationLevel(); !ok {
		return &ValidationError{Name: "escalation_level", err: errors.New(`migrations: missing required field "SLAAlertHistory.escalation_level"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "SLAAlertHistory.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "SLAAlertHistory.created_at"`)}
	}
	if len(_c.mutation.TicketIDs()) == 0 {
		return &ValidationError{Name: "ticket", err: errors.New(`migrations: missing required edge "SLAAlertHistory.ticket"`)}
	}
	if len(_c.mutation.AlertRuleIDs()) == 0 {
		return &ValidationError{Name: "alert_rule", err: errors.New(`migrations: missing required edge "SLAAlertHistory.alert_rule"`)}
	}
	return nil
}
