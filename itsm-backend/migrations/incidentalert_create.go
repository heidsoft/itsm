...
func (_c *IncidentAlertCreate) check() error {
	if _, ok := _c.mutation.IncidentID(); !ok {
		return &ValidationError{Name: "incident_id", err: errors.New(`migrations: missing required field "IncidentAlert.incident_id"`)}
	}
	if v, ok := _c.mutation.IncidentID(); ok {
		if err := incidentalert.IncidentIDValidator(v); err != nil {
			return &ValidationError{Name: "incident_id", err: fmt.Errorf(`migrations: validator failed for field "IncidentAlert.incident_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.AlertType(); !ok {
		return &ValidationError{Name: "alert_type", err: errors.New(`migrations: missing required field "IncidentAlert.alert_type"`)}
	}
	if v, ok := _c.mutation.AlertType(); ok {
		if err := incidentalert.AlertTypeValidator(v); err != nil {
			return &ValidationError{Name: "alert_type", err: fmt.Errorf(`migrations: validator failed for field "IncidentAlert.alert_type": %w`, err)}
		}
	}
	if _, ok := _c.mutation.AlertName(); !ok {
		return &ValidationError{Name: "alert_name", err: errors.New(`migrations: missing required field "IncidentAlert.alert_name"`)}
	}
	if v, ok := _c.mutation.AlertName(); ok {
		if err := incidentalert.AlertNameValidator(v); err != nil {
			return &ValidationError{Name: "alert_name", err: fmt.Errorf(`migrations: validator failed for field "IncidentAlert.alert_name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Message(); !ok {
		return &ValidationError{Name: "message", err: errors.New(`migrations: missing required field "IncidentAlert.message"`)}
	}
	if v, ok := _c.mutation.Message(); ok {
		if err := incidentalert.MessageValidator(v); err != nil {
			return &ValidationError{Name: "message", err: fmt.Errorf(`migrations: validator failed for field "IncidentAlert.message": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Severity(); !ok {
		return &ValidationError{Name: "severity", err: errors.New(`migrations: missing required field "IncidentAlert.severity"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "IncidentAlert.status"`)}
	}
	if _, ok := _c.mutation.TriggeredAt(); !ok {
		return &ValidationError{Name: "triggered_at", err: errors.New(`migrations: missing required field "IncidentAlert.triggered_at"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "IncidentAlert.tenant_id"`)}
	}
	if v, ok := _c.mutation.TenantID(); ok {
		if err := incidentalert.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "IncidentAlert.tenant_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "IncidentAlert.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "IncidentAlert.updated_at"`)}
	}
	if len(_c.mutation.IncidentIDs()) == 0 {
		return &ValidationError{Name: "incident", err: errors.New(`migrations: missing required edge "IncidentAlert.incident"`)}
	}
	return nil
}
