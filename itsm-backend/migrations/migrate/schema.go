...
var (
	...
	// UserPirReviewsColumns holds the columns for the "user_pir_reviews" table.
	UserPirReviewsColumns = []*schema.Column{
		{Name: "user_id", Type: field.TypeInt},
		{Name: "change_pir_id", Type: field.TypeInt},
	}
	// UserPirReviewsTable holds the schema information for the "user_pir_reviews" table.
	UserPirReviewsTable = &schema.Table{
		Name:       "user_pir_reviews",
		Columns:    UserPirReviewsColumns,
		PrimaryKey: []*schema.Column{UserPirReviewsColumns[0], UserPirReviewsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "user_pir_reviews_user_id",
				Columns:    []*schema.Column{UserPirReviewsColumns[0]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "user_pir_reviews_change_pir_id",
				Columns:    []*schema.Column{UserPirReviewsColumns[1]},
				RefColumns: []*schema.Column{ChangePiRsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
...
func init() {
	...
	UserPirReviewsTable.ForeignKeys[0].RefTable = UsersTable
	UserPirReviewsTable.ForeignKeys[1].RefTable = ChangePiRsTable
}
