...
func (_c *ServiceRequestApprovalCreate) check() error {
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "ServiceRequestApproval.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.ServiceRequestID(); !ok {
		return &ValidationError{Name: "service_request_id", err: errors.New(`migrations: missing required field "ServiceRequestApproval.service_request_id"`)}
	}
	...
	if _, ok := _c.mutation.Level(); !ok {
		return &ValidationError{Name: "level", err: errors.New(`migrations: missing required field "ServiceRequestApproval.level"`)}
	}
	...
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "ServiceRequestApproval.status"`)}
	}
	if _, ok := _c.mutation.TimeoutHours(); !ok {
		return &ValidationError{Name: "timeout_hours", err: errors.New(`migrations: missing required field "ServiceRequestApproval.timeout_hours"`)}
	}
	if _, ok := _c.mutation.IsEscalated(); !ok {
		return &ValidationError{Name: "is_escalated", err: errors.New(`migrations: missing required field "ServiceRequestApproval.is_escalated"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ServiceRequestApproval.created_at"`)}
	}
	return nil
}
