...
func (_c *TicketCreate) check() error {
	if _, ok := _c.mutation.Title(); !ok {
		return &ValidationError{Name: "title", err: errors.New(`migrations: missing required field "Ticket.title"`)}
	}
	if v, ok := _c.mutation.Title(); ok {
		if err := ticket.TitleValidator(v); err != nil {
			return &ValidationError{Name: "title", err: fmt.Errorf(`migrations: validator failed for field "Ticket.title": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "Ticket.status"`)}
	}
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`migrations: missing required field "Ticket.type"`)}
	}
	if _, ok := _c.mutation.Priority(); !ok {
		return &ValidationError{Name: "priority", err: errors.New(`migrations: missing required field "Ticket.priority"`)}
	}
	if _, ok := _c.mutation.TicketNumber(); !ok {
		return &ValidationError{Name: "ticket_number", err: errors.New(`migrations: missing required field "Ticket.ticket_number"`)}
	}
	if v, ok := _c.mutation.TicketNumber(); ok {
		if err := ticket.TicketNumberValidator(v); err != nil {
			return &ValidationError{Name: "ticket_number", err: fmt.Errorf(`migrations: validator failed for field "Ticket.ticket_number": %w`, err)}
		}
	}
	if _, ok := _c.mutation.RequesterID(); !ok {
		return &ValidationError{Name: "requester_id", err: errors.New(`migrations: missing required field "Ticket.requester_id"`)}
	}
	if v, ok := _c.mutation.RequesterID(); ok {
		if err := ticket.RequesterIDValidator(v); err != nil {
			return &ValidationError{Name: "requester_id", err: fmt.Errorf(`migrations: validator failed for field "Ticket.requester_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "Ticket.tenant_id"`)}
	}
	if v, ok := _c.mutation.TenantID(); ok {
		if err := ticket.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "Ticket.tenant_id": %w`, err)}
		}
	}
	if v, ok := _c.mutation.Rating(); ok {
		if err := ticket.RatingValidator(v); err != nil {
			return &ValidationError{Name: "rating", err: fmt.Errorf(`migrations: validator failed for field "Ticket.rating": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`migrations: missing required field "Ticket.version"`)}
	}
	if v, ok := _c.mutation.Version(); ok {
		if err := ticket.VersionValidator(v); err != nil {
			return &ValidationError{Name: "version", err: fmt.Errorf(`migrations: validator failed for field "Ticket.version": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "Ticket.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "Ticket.updated_at"`)}
	}
	if _, ok := _c.mutation.IsManagedByMsp(); !ok {
		return &ValidationError{Name: "is_managed_by_msp", err: errors.New(`migrations: missing required field "Ticket.is_managed_by_msp"`)}
	}
	return nil
}
