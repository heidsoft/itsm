...
func (_c *IncidentMetricCreate) check() error {
	if _, ok := _c.mutation.IncidentID(); !ok {
		return &ValidationError{Name: "incident_id", err: errors.New(`migrations: missing required field "IncidentMetric.incident_id"`)}
	}
	if v, ok := _c.mutation.IncidentID(); ok {
		if err := incidentmetric.IncidentIDValidator(v); err != nil {
			return &ValidationError{Name: "incident_id", err: fmt.Errorf(`migrations: validator failed for field "IncidentMetric.incident_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.MetricType(); !ok {
		return &ValidationError{Name: "metric_type", err: errors.New(`migrations: missing required field "IncidentMetric.metric_type"`)}
	}
	if v, ok := _c.mutation.MetricType(); ok {
		if err := incidentmetric.MetricTypeValidator(v); err != nil {
			return &ValidationError{Name: "metric_type", err: fmt.Errorf(`migrations: validator failed for field "IncidentMetric.metric_type": %w`, err)}
		}
	}
	if _, ok := _c.mutation.MetricName(); !ok {
		return &ValidationError{Name: "metric_name", err: errors.New(`migrations: missing required field "IncidentMetric.metric_name"`)}
	}
	if v, ok := _c.mutation.MetricName(); ok {
		if err := incidentmetric.MetricNameValidator(v); err != nil {
			return &ValidationError{Name: "metric_name", err: fmt.Errorf(`migrations: validator failed for field "IncidentMetric.metric_name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.MetricValue(); !ok {
		return &ValidationError{Name: "metric_value", err: errors.New(`migrations: missing required field "IncidentMetric.metric_value"`)}
	}
	if _, ok := _c.mutation.MeasuredAt(); !ok {
		return &ValidationError{Name: "measured_at", err: errors.New(`migrations: missing required field "IncidentMetric.measured_at"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "IncidentMetric.tenant_id"`)}
	}
	if v, ok := _c.mutation.TenantID(); ok {
		if err := incidentmetric.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "IncidentMetric.tenant_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "IncidentMetric.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "IncidentMetric.updated_at"`)}
	}
	if len(_c.mutation.IncidentIDs()) == 0 {
		return &ValidationError{Name: "incident", err: errors.New(`migrations: missing required edge "IncidentMetric.incident"`)}
	}
	return nil
}
