...
func (_c *RootCauseAnalysisCreate) check() error {
	if _, ok := _c.mutation.TicketID(); !ok {
		return &ValidationError{Name: "ticket_id", err: errors.New(`migrations: missing required field "RootCauseAnalysis.ticket_id"`)}
	}
	...
	if _, ok := _c.mutation.TicketNumber(); !ok {
		return &ValidationError{Name: "ticket_number", err: errors.New(`migrations: missing required field "RootCauseAnalysis.ticket_number"`)}
	}
	...
	if _, ok := _c.mutation.TicketTitle(); !ok {
		return &ValidationError{Name: "ticket_title", err: errors.New(`migrations: missing required field "RootCauseAnalysis.ticket_title"`)}
	}
	...
	if _, ok := _c.mutation.AnalysisDate(); !ok {
		return &ValidationError{Name: "analysis_date", err: errors.New(`migrations: missing required field "RootCauseAnalysis.analysis_date"`)}
	}
	...
	if _, ok := _c.mutation.RootCauses(); !ok {
		return &ValidationError{Name: "root_causes", err: errors.New(`migrations: missing required field "RootCauseAnalysis.root_causes"`)}
	}
	if _, ok := _c.mutation.ConfidenceScore(); !ok {
		return &ValidationError{Name: "confidence_score", err: errors.New(`migrations: missing required field "RootCauseAnalysis.confidence_score"`)}
	}
	...
	if _, ok := _c.mutation.AnalysisMethod(); !ok {
		return &ValidationError{Name: "analysis_method", err: errors.New(`migrations: missing required field "RootCauseAnalysis.analysis_method"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "RootCauseAnalysis.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "RootCauseAnalysis.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "RootCauseAnalysis.updated_at"`)}
	}
	if len(_c.mutation.TicketIDs()) == 0 {
		return &ValidationError{Name: "ticket", err: errors.New(`migrations: missing required edge "RootCauseAnalysis.ticket"`)}
	}
	return nil
}
