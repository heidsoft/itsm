...
func (_c *IncidentCreate) check() error {
	if _, ok := _c.mutation.Title(); !ok {
		return &ValidationError{Name: "title", err: errors.New(`migrations: missing required field "Incident.title"`)}
	}
	...
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "Incident.status"`)}
	}
	if _, ok := _c.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`migrations: missing required field "Incident.type"`)}
	}
	if _, ok := _c.mutation.Priority(); !ok {
		return &ValidationError{Name: "priority", err: errors.New(`migrations: missing required field "Incident.priority"`)}
	}
	if _, ok := _c.mutation.Severity(); !ok {
		return &ValidationError{Name: "severity", err: errors.New(`migrations: missing required field "Incident.severity"`)}
	}
	if _, ok := _c.mutation.IncidentNumber(); !ok {
		return &ValidationError{Name: "incident_number", err: errors.New(`migrations: missing required field "Incident.incident_number"`)}
	}
	...
	if _, ok := _c.mutation.ReporterID(); !ok {
		return &ValidationError{Name: "reporter_id", err: errors.New(`migrations: missing required field "Incident.reporter_id"`)}
	}
	...
	if _, ok := _c.mutation.DetectedAt(); !ok {
		return &ValidationError{Name: "detected_at", err: errors.New(`migrations: missing required field "Incident.detected_at"`)}
	}
	if _, ok := _c.mutation.EscalationLevel(); !ok {
		return &ValidationError{Name: "escalation_level", err: errors.New(`migrations: missing required field "Incident.escalation_level"`)}
	}
	if _, ok := _c.mutation.IsAutomated(); !ok {
		return &ValidationError{Name: "is_automated", err: errors.New(`migrations: missing required field "Incident.is_automated"`)}
	}
	if _, ok := _c.mutation.IsMajorIncident(); !ok {
		return &ValidationError{Name: "is_major_incident", err: errors.New(`migrations: missing required field "Incident.is_major_incident"`)}
	}
	if _, ok := _c.mutation.Source(); !ok {
		return &ValidationError{Name: "source", err: errors.New(`migrations: missing required field "Incident.source"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "Incident.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`migrations: missing required field "Incident.version"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "Incident.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "Incident.updated_at"`)}
	}
	return nil
}
