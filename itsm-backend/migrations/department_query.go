...
func (_q *DepartmentQuery) QueryTickets() *TicketQuery {
...
func (_q *DepartmentQuery) QueryCategories() *TicketCategoryQuery {
...
func (_q *DepartmentQuery) QueryProjects() *ProjectQuery {
...
func (_q *DepartmentQuery) QueryTags() *TagQuery {
...
func (_q *DepartmentQuery) WithTickets(opts ...func(*TicketQuery)) *DepartmentQuery {
	query := (&TicketClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) WithCategories(opts ...func(*TicketCategoryQuery)) *DepartmentQuery {
	query := (&TicketCategoryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) WithProjects(opts ...func(*ProjectQuery)) *DepartmentQuery {
	query := (&ProjectClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) WithTags(opts ...func(*TagQuery)) *DepartmentQuery {
	query := (&TagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) loadTickets(ctx context.Context, query *TicketQuery, nodes []*Department, init func(*Department), assign func(*Department, *Ticket)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Department)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *DepartmentQuery) loadCategories(ctx context.Context, query *TicketCategoryQuery, nodes []*Department, init func(*Department), assign func(*Department, *TicketCategory)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Department)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *DepartmentQuery) loadProjects(ctx context.Context, query *ProjectQuery, nodes []*Department, init func(*Department), assign func(*Department, *Project)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Department)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *DepartmentQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*Department, init func(*Department), assign func(*Department, *Tag)) error {
