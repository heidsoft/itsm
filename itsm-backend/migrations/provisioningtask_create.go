...
func (_c *ProvisioningTaskCreate) check() error {
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "ProvisioningTask.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.ServiceRequestID(); !ok {
		return &ValidationError{Name: "service_request_id", err: errors.New(`migrations: missing required field "ProvisioningTask.service_request_id"`)}
	}
	...
	if _, ok := _c.mutation.Provider(); !ok {
		return &ValidationError{Name: "provider", err: errors.New(`migrations: missing required field "ProvisioningTask.provider"`)}
	}
	if _, ok := _c.mutation.ResourceType(); !ok {
		return &ValidationError{Name: "resource_type", err: errors.New(`migrations: missing required field "ProvisioningTask.resource_type"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "ProvisioningTask.status"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ProvisioningTask.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "ProvisioningTask.updated_at"`)}
	}
	return nil
}
