...
func (_u *DepartmentUpdate) check() error {
	if v, ok := _u.mutation.Name(); ok {
		if err := department.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`migrations: validator failed for field "Department.name": %w`, err)}
		}
	}
	if v, ok := _u.mutation.Code(); ok {
		if err := department.CodeValidator(v); err != nil {
			return &ValidationError{Name: "code", err: fmt.Errorf(`migrations: validator failed for field "Department.code": %w`, err)}
		}
	}
	if v, ok := _u.mutation.TenantID(); ok {
		if err := department.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "Department.tenant_id": %w`, err)}
		}
	}
	return nil
}
...
func (_u *DepartmentUpdateOne) sqlSave(ctx context.Context) (_node *Department, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`migrations: missing "Department.id" for update`)}
	}
