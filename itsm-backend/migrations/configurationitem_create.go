...
func (_c *ConfigurationItemCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`migrations: missing required field "ConfigurationItem.name"`)}
	}
	...
	if _, ok := _c.mutation.CiTypeID(); !ok {
		return &ValidationError{Name: "ci_type_id", err: errors.New(`migrations: missing required field "ConfigurationItem.ci_type_id"`)}
	}
	...
	if _, ok := _c.mutation.CiType(); !ok {
		return &ValidationError{Name: "ci_type", err: errors.New(`migrations: missing required field "ConfigurationItem.ci_type"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`migrations: missing required field "ConfigurationItem.status"`)}
	}
	if _, ok := _c.mutation.Environment(); !ok {
		return &ValidationError{Name: "environment", err: errors.New(`migrations: missing required field "ConfigurationItem.environment"`)}
	}
	if _, ok := _c.mutation.Criticality(); !ok {
		return &ValidationError{Name: "criticality", err: errors.New(`migrations: missing required field "ConfigurationItem.criticality"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "ConfigurationItem.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "ConfigurationItem.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "ConfigurationItem.updated_at"`)}
	}
	if len(_c.mutation.CiTypeRefIDs()) == 0 {
		return &ValidationError{Name: "ci_type_ref", err: errors.New(`migrations: missing required edge "ConfigurationItem.ci_type_ref"`)}
	}
	return nil
}
