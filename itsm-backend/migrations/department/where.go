...
func ManagerID(v int) predicate.Department {
...
func HasWorkflows() predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWorkflowsWith(preds ...predicate.Workflow) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
...
func HasCategories() predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCategoriesWith(preds ...predicate.TicketCategory) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
...
func HasTags() predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTagsWith(preds ...predicate.Tag) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := newTagsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
