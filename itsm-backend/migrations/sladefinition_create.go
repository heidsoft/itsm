...
func (_c *SLADefinitionCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`migrations: missing required field "SLADefinition.name"`)}
	}
	if v, ok := _c.mutation.Name(); ok {
		if err := sladefinition.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`migrations: validator failed for field "SLADefinition.name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.ResponseTime(); !ok {
		return &ValidationError{Name: "response_time", err: errors.New(`migrations: missing required field "SLADefinition.response_time"`)}
	}
	if v, ok := _c.mutation.ResponseTime(); ok {
		if err := sladefinition.ResponseTimeValidator(v); err != nil {
			return &ValidationError{Name: "response_time", err: fmt.Errorf(`migrations: validator failed for field "SLADefinition.response_time": %w`, err)}
		}
	}
	if _, ok := _c.mutation.ResolutionTime(); !ok {
		return &ValidationError{Name: "resolution_time", err: errors.New(`migrations: missing required field "SLADefinition.resolution_time"`)}
	}
	if v, ok := _c.mutation.ResolutionTime(); ok {
		if err := sladefinition.ResolutionTimeValidator(v); err != nil {
			return &ValidationError{Name: "resolution_time", err: fmt.Errorf(`migrations: validator failed for field "SLADefinition.resolution_time": %w`, err)}
		}
	}
	if _, ok := _c.mutation.IsActive(); !ok {
		return &ValidationError{Name: "is_active", err: errors.New(`migrations: missing required field "SLADefinition.is_active"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "SLADefinition.tenant_id"`)}
	}
	if v, ok := _c.mutation.TenantID(); ok {
		if err := sladefinition.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`migrations: validator failed for field "SLADefinition.tenant_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "SLADefinition.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "SLADefinition.updated_at"`)}
	}
	return nil
}
