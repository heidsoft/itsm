...
func (_u *RolePermissionUpdate) AddRoleID(v int) *RolePermissionUpdate {
...
func (_u *RolePermissionUpdate) AddPermissionID(v int) *RolePermissionUpdate {
...
func (_u *RolePermissionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedRoleID(); ok {
		_spec.AddField(rolepermission.FieldRoleID, field.TypeInt, value)
	}
...
// AddRoleID adds value to the "role_id" field.
func (_u *RolePermissionUpdateOne) AddRoleID(v int) *RolePermissionUpdateOne {
	_u.mutation.AddRoleID(v)
	return _u
}
...
func (_u *RolePermissionUpdateOne) sqlSave(ctx context.Context) (_node *RolePermission, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`migrations: missing "RolePermission.id" for update`)}
	}
