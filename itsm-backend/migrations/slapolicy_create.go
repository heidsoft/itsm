...
func (_c *SLAPolicyCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`migrations: missing required field "SLAPolicy.name"`)}
	}
	...
	if _, ok := _c.mutation.ResponseTimeMinutes(); !ok {
		return &ValidationError{Name: "response_time_minutes", err: errors.New(`migrations: missing required field "SLAPolicy.response_time_minutes"`)}
	}
	...
	if _, ok := _c.mutation.ResolutionTimeMinutes(); !ok {
		return &ValidationError{Name: "resolution_time_minutes", err: errors.New(`migrations: missing required field "SLAPolicy.resolution_time_minutes"`)}
	}
	...
	if _, ok := _c.mutation.ExcludeWeekends(); !ok {
		return &ValidationError{Name: "exclude_weekends", err: errors.New(`migrations: missing required field "SLAPolicy.exclude_weekends"`)}
	}
	if _, ok := _c.mutation.ExcludeHolidays(); !ok {
		return &ValidationError{Name: "exclude_holidays", err: errors.New(`migrations: missing required field "SLAPolicy.exclude_holidays"`)}
	}
	if _, ok := _c.mutation.IsActive(); !ok {
		return &ValidationError{Name: "is_active", err: errors.New(`migrations: missing required field "SLAPolicy.is_active"`)}
	}
	if _, ok := _c.mutation.PriorityScore(); !ok {
		return &ValidationError{Name: "priority_score", err: errors.New(`migrations: missing required field "SLAPolicy.priority_score"`)}
	}
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`migrations: missing required field "SLAPolicy.tenant_id"`)}
	}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`migrations: missing required field "SLAPolicy.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`migrations: missing required field "SLAPolicy.updated_at"`)}
	}
	return nil
}
