...
func (_q *OnCallShiftQuery) QuerySchedule() *OnCallScheduleQuery {
...
func (_q *OnCallShiftQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *OnCallShiftQuery) FirstIDX(ctx context.Context) int {
...
func (_q *OnCallShiftQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *OnCallShiftQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *OnCallShiftQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *OnCallShiftQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *OnCallShiftQuery) WithSchedule(opts ...func(*OnCallScheduleQuery)) *OnCallShiftQuery {
	query := (&OnCallScheduleClient{config: _q.config}).Query()
...
func (_q *OnCallShiftQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OnCallShift, error) {
	...
	if query := _q.withSchedule; query != nil {
		if err := _q.loadSchedule(ctx, query, nodes, nil,
			func(n *OnCallShift, e *OnCallSchedule) { n.Edges.Schedule = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *OnCallShiftQuery) loadSchedule(ctx context.Context, query *OnCallScheduleQuery, nodes []*OnCallShift, init func(*OnCallShift), assign func(*OnCallShift, *OnCallSchedule)) error {
...
func (_q *OnCallShiftQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(oncallshift.Table, oncallshift.Columns, sqlgraph.NewFieldSpec(oncallshift.FieldID, field.TypeInt))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSchedule != nil {
			_spec.Node.AddColumnOnce(oncallshift.FieldScheduleID)
		}
		if _q.withUser != nil {
