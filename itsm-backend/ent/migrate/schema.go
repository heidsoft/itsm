...
var (
	...
	ChangesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "change_number", Type: field.TypeString, Nullable: true},
	...
	// ChangeReviewMembersColumns holds the columns for the "change_review_members" table.
	ChangeReviewMembersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
	...
	// ChangeReviewMembersTable holds the schema information for the "change_review_members" table.
	ChangeReviewMembersTable = &schema.Table{
		Name:       "change_review_members",
		Columns:    ChangeReviewMembersColumns,
		PrimaryKey: []*schema.Column{ChangeReviewMembersColumns[0]},
	}
	...
	CloudResourcesColumns = []*schema.Column{
		...
		{Name: "identity_version", Type: field.TypeInt, Default: 1},
		{Name: "provider", Type: field.TypeString, Nullable: true},
		{Name: "partition", Type: field.TypeString, Default: "public"},
		{Name: "canonical_account_id", Type: field.TypeString, Nullable: true},
		{Name: "resource_scope", Type: field.TypeString, Default: "regional"},
		{Name: "service_code", Type: field.TypeString, Nullable: true},
		{Name: "resource_type", Type: field.TypeString, Nullable: true},
		{Name: "identity_hash", Type: field.TypeString, Nullable: true},
		{Name: "source_id", Type: field.TypeString, Nullable: true},
		{Name: "source_fingerprint", Type: field.TypeString, Nullable: true},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{CloudResourcesColumns[22]},
			},
			{
				Name:    "cloudresource_cloud_account_id_resource_id",
				Unique:  false,
				Columns: []*schema.Column{CloudResourcesColumns[25], CloudResourcesColumns[1]},
			},
			{
			...
			{
				Name:    "cloudresource_tenant_id_identity_hash",
				Unique:  false,
				Columns: []*schema.Column{CloudResourcesColumns[22], CloudResourcesColumns[9]},
			},
		},
	}
	...
	ConfigurationItemsColumns = []*schema.Column{
		...
		{Name: "source_id", Type: field.TypeString, Nullable: true},
		{Name: "canonical_cloud_account_id", Type: field.TypeString, Nullable: true},
		{Name: "source_last_seen_at", Type: field.TypeTime, Nullable: true},
		{Name: "source_missing_count", Type: field.TypeInt, Default: 0},
		{Name: "source_fingerprint", Type: field.TypeString, Nullable: true},
	...
	DiscoveryJobsColumns = []*schema.Column{
		...
		{Name: "operation", Type: field.TypeString, Default: "full_discovery"},
		{Name: "idempotency_key", Type: field.TypeString, Nullable: true},
		{Name: "request_fingerprint", Type: field.TypeString, Nullable: true},
		{Name: "source_snapshot", Type: field.TypeJSON, Nullable: true},
		{Name: "scope_snapshot", Type: field.TypeJSON, Nullable: true},
		{Name: "completed_scopes", Type: field.TypeJSON, Nullable: true},
		{Name: "failed_scopes", Type: field.TypeJSON, Nullable: true},
		{Name: "snapshot_generation", Type: field.TypeString, Nullable: true},
		{Name: "requested_by", Type: field.TypeInt, Nullable: true},
		...
		{Name: "parent_job_id", Type: field.TypeInt, Nullable: true},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{DiscoveryJobsColumns[29]},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DiscoveryJobsColumns[26]},
			},
			{
			...
			{
				Name:    "discoveryjob_tenant_id_operation_source_id_idempotency_key",
				Unique:  false,
				Columns: []*schema.Column{DiscoveryJobsColumns[26], DiscoveryJobsColumns[2], DiscoveryJobsColumns[29], DiscoveryJobsColumns[3]},
			},
			{
				Name:    "discoveryjob_status_lease_expires_at",
				Unique:  false,
				Columns: []*schema.Column{DiscoveryJobsColumns[1], DiscoveryJobsColumns[14]},
			},
		},
	}
	...
	DiscoveryResultsColumns = []*schema.Column{
		...
		{Name: "resource_identity", Type: field.TypeString, Nullable: true},
		{Name: "identity_version", Type: field.TypeInt, Default: 1},
		{Name: "resource_snapshot", Type: field.TypeJSON, Nullable: true},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{DiscoveryResultsColumns[17]},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DiscoveryResultsColumns[14]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DiscoveryResultsColumns[11]},
			},
			{
				Name:    "discoveryresult_tenant_id_job_id_resource_identity",
				Unique:  false,
				Columns: []*schema.Column{DiscoveryResultsColumns[14], DiscoveryResultsColumns[17], DiscoveryResultsColumns[5]},
			},
		},
	}
	...
	DiscoverySourcesColumns = []*schema.Column{
		...
		{Name: "provider", Type: field.TypeString, Nullable: true},
		{Name: "cloud_account_id", Type: field.TypeInt, Nullable: true},
		{Name: "service_codes", Type: field.TypeJSON, Nullable: true},
		{Name: "regions", Type: field.TypeJSON, Nullable: true},
		{Name: "schedule", Type: field.TypeString, Nullable: true},
		{Name: "reconcile_policy", Type: field.TypeString, Default: "manual"},
		{Name: "stale_threshold", Type: field.TypeInt, Default: 3},
		{Name: "last_success_at", Type: field.TypeTime, Nullable: true},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DiscoverySourcesColumns[13]},
			},
			{
				Name:    "discoverysource_tenant_id_cloud_account_id",
				Unique:  false,
				Columns: []*schema.Column{DiscoverySourcesColumns[13], DiscoverySourcesColumns[4]},
			},
			{
				Name:    "discoverysource_tenant_id_name",
				Unique:  true,
				Columns: []*schema.Column{DiscoverySourcesColumns[13], DiscoverySourcesColumns[1]},
			},
		},
	}
	...
	ProblemsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "problem_number", Type: field.TypeString, Nullable: true},
		{Name: "title", Type: field.TypeString},
		{Name: "description", Type: field.TypeString, Nullable: true, Size: 2147483647},
	...
	TicketsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Default: "open"},
		{Name: "type", Type: field.TypeString, Default: "incident"},
		{Name: "ticket_type_code_snapshot", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "ticket_type_name_snapshot", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "form_fields", Type: field.TypeJSON},
		{Name: "priority", Type: field.TypeString, Default: "medium"},
		...
		{Name: "ticket_type_id", Type: field.TypeInt, Nullable: true},
		{Name: "requester_id", Type: field.TypeInt},
		{Name: "assignee_id", Type: field.TypeInt, Nullable: true},
	}
	...
	TicketsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{TicketsColumns[3], TicketsColumns[8]},
			},
			{
	...
	TicketCategoriesColumns = []*schema.Column{
		...
		{Name: "is_active", Type: field.TypeBool, Default: true},
		{Name: "tenant_id", Type: field.TypeInt},
		{Name: "workflow_definition_key", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "department_id", Type: field.TypeInt, Nullable: true},
		{Name: "parent_id", Type: field.TypeInt, Nullable: true},
	...
	TicketTypesColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Default: "active"},
		{Name: "category_id", Type: field.TypeInt, Nullable: true},
		{Name: "default_priority", Type: field.TypeString, Size: 20, Default: "medium"},
		{Name: "sort_order", Type: field.TypeInt, Default: 0},
		{Name: "workflow_definition_key", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "assignment_rule_id", Type: field.TypeInt, Nullable: true},
		{Name: "archived_at", Type: field.TypeTime, Nullable: true},
		{Name: "archived_by", Type: field.TypeInt64, Nullable: true},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TicketTypesColumns[1], TicketTypesColumns[24]},
			},
			{
				Name:    "tickettype_tenant_id",
				Unique:  false,
				Columns: []*schema.Column{TicketTypesColumns[24]},
			},
			{
			...
			{
				Name:    "tickettype_tenant_id_sort_order",
				Unique:  false,
				Columns: []*schema.Column{TicketTypesColumns[24], TicketTypesColumns[9]},
			},
		},
	}
...
func init() {
	...
	TicketsTable.ForeignKeys[7].RefTable = TicketTypesTable
	TicketsTable.ForeignKeys[8].RefTable = UsersTable
	TicketsTable.ForeignKeys[9].RefTable = UsersTable
