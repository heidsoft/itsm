...
func (tq *TeamQuery) QueryTags() *TagQuery {
...
func (tq *TeamQuery) WithTags(opts ...func(*TagQuery)) *TeamQuery {
	query := (&TagClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (tq *TeamQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*Team, init func(*Team), assign func(*Team, *Tag)) error {
