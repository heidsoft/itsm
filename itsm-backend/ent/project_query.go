...
func (pq *ProjectQuery) QueryDepartment() *DepartmentQuery {
...
func (pq *ProjectQuery) WithDepartment(opts ...func(*DepartmentQuery)) *ProjectQuery {
	query := (&DepartmentClient{config: pq.config}).Query()
...
func (pq *ProjectQuery) loadDepartment(ctx context.Context, query *DepartmentQuery, nodes []*Project, init func(*Project), assign func(*Project, *Department)) error {
...
func (pq *ProjectQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*Project, init func(*Project), assign func(*Project, *Tag)) error {
