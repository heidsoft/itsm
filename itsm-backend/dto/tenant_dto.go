...
type CreateTenantRequest struct {
	...
	Type      string                 `json:"type" binding:"required,oneof=trial standard professional enterprise msp customer" comment:"租户类型"`
...
type UpdateTenantRequest struct {
	...
	Domain    *string                `json:"domain,omitempty" binding:"omitempty,max=100" comment:"自定义域名"`
	Type      *string                `json:"type,omitempty" binding:"omitempty,oneof=trial standard professional enterprise msp customer" comment:"租户类型"`
...
type ListTenantsRequest struct {
	...
	Type     string `form:"type" binding:"omitempty,oneof=trial standard professional enterprise msp customer" comment:"类型过滤"`
