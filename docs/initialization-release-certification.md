...
> Status: historical。本文记录 2026-07-30 的 v1.5.0 候选验证，不代表当前工作树或运行镜像。当前发布判断请先查看[文档状态与事实源](documentation-governance.md)；历史输出 `output/product-deployment-business-test-2026-08-14.md` 未纳入版本库，不能作为可复核证据。文中的“阻断项已全部关闭”仅适用于当次证据，不得作为后续发布签字。
